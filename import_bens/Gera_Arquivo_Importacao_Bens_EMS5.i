...
DEFINE TEMP-TABLE tt-import-bens
    ...
    FIELD cEstabel                  AS CHARACTER  FORMAT "x(3)"
    ...
    FIELD cFornecedor               AS INTEGER    FORMAT 999999
    FIELD cLocalizadao              AS CHARACTER  FORMAT "x(12)"
