...
DEFINE VARIABLE cEstabel                  AS CHARACTER NO-UNDO FORMAT "X(5)".
...
DEFINE VARIABLE cDoctoEntrada             AS CHARACTER NO-UNDO FORMAT "X(16)".
...
DEFINE VARIABLE cSerieNota                AS CHARACTER NO-UNDO FORMAT "X(5)".
