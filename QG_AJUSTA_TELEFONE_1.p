...
FOR EACH emitente WHERE emitente.cod-emitente = iCodEmitente:

    ASSIGN cMem                 = emitente.telefone[1]
           emitente.telefone[1] = emitente.telefone[2]
           emitente.telefone[2] = cMem.
    ...
    DISP emitente.telefone[1]
         emitente.telefone[2]
         cAjustado FORMAT "x(16)".
