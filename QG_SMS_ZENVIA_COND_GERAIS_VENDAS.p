...
ASSIGN cTargetType = "LONGCHAR"
    ...
    ASSIGN sendSmsRequest.from_          = "DSM"
           sendSmsRequest.to_            = "5511971201913"
           sendSmsRequest.schedule       = ""
           sendSmsRequest.msg            = "Prezado cliente, clique no link a seguir para visualizar a atualiza‡Æo das condi‡äes gerais de vendas da DSM|Tortuga: https://goo.gl/Zmzm40"
           /*sendSmsRequest.msg            = "https://goo.gl/Zmzm40"*/
           sendSmsRequest.callbackOption = "NONE"
           sendSmsRequest.id             = "000KKK"
