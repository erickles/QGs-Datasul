...
OUTPUT TO "C:\Temp\comunica_email.csv".
...
FOR EACH es-comunica-cliente-envio WHERE es-comunica-cliente-envio.data-envio >= 03/17/2017
                                     AND es-comunica-cliente-envio.data-envio <= 03/17/2017
