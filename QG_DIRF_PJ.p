...
FOR EACH dirf_apb NO-LOCK WHERE YEAR(dirf_apb.dat_refer) = 2016:
    FIND FIRST emsuni.pessoa_jurid WHERE emsuni.pessoa_jurid.num_pessoa_jurid = dirf_apb.num_pessoa NO-LOCK NO-ERROR.
    IF AVAIL emsuni.pessoa_jurid THEN DO:

        PUT emsuni.pessoa_jurid.num_pessoa_jurid    ";"
