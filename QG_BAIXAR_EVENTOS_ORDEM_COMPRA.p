        ...
        FOR EACH es-ev-integr-desp WHERE (es-ev-integr-desp.origem         = "OC"   OR
            ...
            CASE es-ev-integr-desp.origem:
                ...
                WHEN "OC" THEN DO:                    
                    ...
                    FIND FIRST ordem-compra WHERE ordem-compra.numero-ordem = es-ev-integr-desp.numero-ordem NO-LOCK NO-ERROR.
                    IF AVAIL ordem-compra THEN DO:                                                
                        
                        FIND FIRST es-ev-despesas WHERE es-ev-despesas.cod-evento     = es-ev-integr-desp.cod-evento    
                        ...
                        IF AVAIL es-ev-despesas THEN
                            MESSAGE "DELETE a es-ev-despesas"
                                    VIEW-AS ALERT-BOX INFO BUTTONS OK.
                            /*DELETE es-ev-despesas.    */
    
                        /*DELETE es-ev-integr-desp.*/
                        MESSAGE "DELETE a es-ev-integr-desp"
                                VIEW-AS ALERT-BOX INFO BUTTONS OK.
