...
DEFINE VARIABLE nr-nota-fis LIKE nota-fiscal.nr-nota-fis   NO-UNDO.
...
INPUT FROM "C:\Temp\CARIMBO_13082015.csv".
...
REPEAT:
    ...
    IMPORT DELIMITER ";" cod-estabel
                         ...
                         cstcofins.
    /*
    MESSAGE TRIM(REPLACE(nr-nota-fis, "'", "")) SKIP
            serie                               SKIP
            Trim(REPLACE(cod-estabel, "'", "")) SKIP
            ITEM                               
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
    */
    FIND FIRST it-nota-fisc WHERE it-nota-fisc.nr-nota-fis = TRIM(REPLACE(nr-nota-fis, "'", ""))
